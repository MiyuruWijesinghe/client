...
@Component({
  selector: 'app-year-wise-income',
  templateUrl: './year-wise-income.component.html',
  styleUrls: ['./year-wise-income.component.scss']
})
export class YearWiseIncomeComponent extends AbstractComponent implements OnInit {
  ...
  async loadData(): Promise<any>{
    this.yearWiseData = await this.reportService.getYearWiseIncome(this.yearField.value);
  ...
  print(): void{
    ReportHelper.print('yearWiseIncomeReport');
  }
}
