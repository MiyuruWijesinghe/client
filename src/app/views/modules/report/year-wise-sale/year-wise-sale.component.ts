...
@Component({
  selector: 'app-year-wise-sale',
  templateUrl: './year-wise-sale.component.html',
  styleUrls: ['./year-wise-sale.component.scss']
})
export class YearWiseSaleComponent extends AbstractComponent implements OnInit {
  ...
  async loadData(): Promise<any>{
    this.yearWiseData = await this.reportService.getYearWiseSale(this.yearField.value);
