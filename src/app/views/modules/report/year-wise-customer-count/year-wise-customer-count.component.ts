...
@Component({
  selector: 'app-year-wise-customer-count',
  templateUrl: './year-wise-customer-count.component.html',
  styleUrls: ['./year-wise-customer-count.component.scss']
})
export class YearWiseCustomerCountComponent extends AbstractComponent implements OnInit {
  ...
  async loadData(): Promise<any>{
    this.yearWiseData = await this.reportService.getYearWiseCustomerCount(this.yearField.value);
  ...
  print(): void{
    ReportHelper.print('yearWiseCustomerCountReport');
  }
