...
export class CustomerUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void {
    if (this.nameField.pristine) {
      this.nameField.patchValue(this.customer.name);
    }
    if (this.nicField.pristine) {
      this.nicField.patchValue(this.customer.nic);
    }
    if (this.contact1Field.pristine) {
      this.contact1Field.patchValue(this.customer.contact1);
    }
    if (this.contact2Field.pristine) {
      this.contact2Field.patchValue(this.customer.contact2);
    }
    if (this.emailField.pristine) {
      this.emailField.patchValue(this.customer.email);
    }
    if (this.passportField.pristine) {
      this.passportField.patchValue(this.customer.passport);
    }
    if (this.faxField.pristine) {
      this.faxField.patchValue(this.customer.fax);
    }
    if (this.addressField.pristine) {
      this.addressField.patchValue(this.customer.address);
    }
    if (this.descriptionField.pristine) {
      this.descriptionField.patchValue(this.customer.description);
    }
  }
}
