...
export class PurchaseUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void{
    if (this.descriptionField.pristine){ this.descriptionField.patchValue(this.purchase.description); }
    if (this.branchField.pristine){ this.branchField.patchValue(this.purchase.branch.id); }
    if (this.porderField.pristine){ this.porderField.patchValue(this.purchase.porder.id); }
    if (this.amountField.pristine){ this.amountField.patchValue(this.purchase.amount); }
