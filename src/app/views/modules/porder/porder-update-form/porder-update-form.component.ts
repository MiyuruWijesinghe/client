...
export class PorderUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void {
    if (this.descriptionField.pristine) {
      this.descriptionField.patchValue(this.porder.description);
    }
    if (this.dorecievedField.pristine) {
      this.dorecievedField.patchValue(this.porder.dorecieved);
    }
    if (this.porderstatusField.pristine) {
      this.porderstatusField.patchValue(this.porder.porderstatus.id);
    }
    if (this.porderitemsField.pristine) {
      this.porderitemsField.patchValue(this.porder.porderitemList);
    }
