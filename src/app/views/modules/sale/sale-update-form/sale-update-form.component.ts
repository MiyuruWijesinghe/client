...
export class SaleUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void {
    if (this.amountField.pristine) {
      this.amountField.patchValue(this.sale.amount);
    }
    if (this.customerField.pristine) {
      this.customerField.patchValue(this.sale.customer.id);
    }
    if (this.descriptionField.pristine) {
      this.descriptionField.patchValue(this.sale.description);
    }
    if (this.saleitemsField.pristine) {
      this.saleitemsField.patchValue(this.sale.saleitemList);
    }
    if (this.branchField.pristine) {
      this.branchField.patchValue(this.sale.branch.id);
    }
